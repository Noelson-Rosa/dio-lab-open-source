...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -n feat/community/seunomedeusuario`;
    > Exemplo: `git checkout -n feat/community/felipesntsassis`
